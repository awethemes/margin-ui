...
This guide provides the essentials for adding **Margin-UI** components to your React application.
...
You can install all **Margin-UI** primitives at once with a single command:
...
This command installs both the UI components and our default zinc-based color system, which provides crisp, contrasted borders and enhanced visual depth. See the [Styling](/ui/docs/styling) guide for more details about our color system.
...
The variables are compatible with shadcn/ui, and are fully customizable. You can modify them in your global stylesheet (e.g., `app/globals.css`) to match your design system.
