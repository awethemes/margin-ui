...
const Ruler = ({ orientation = "horizontal", className = "" }) => {
  return (
    <div
      className={`flex overflow-hidden opacity-30 pointer-events-none select-none ${
        orientation === "horizontal"
          ? "w-full h-6 border-b border-neutral-900"
          : "h-full w-6 flex-col border-r border-neutral-900"
      } ${className}`}
    >
      {Array.from({ length: 100 }).map((_, i) => (
        ...
        >
          <div
            className={`${
              orientation === "horizontal" ? "h-1 w-px" : "w-1 h-px"
            } bg-neutral-900`}
          />
          <div
            className={`${
              orientation === "horizontal" ? "h-2 w-px" : "w-2 h-px"
            } bg-neutral-900`}
          />
          <div
            className={`${
          ...
          {i % 5 === 0 && (
            <span
              className={`text-[8px] font-mono absolute ${
                orientation === "horizontal" ? "-top-2 ml-1" : "-left-4 mt-1"
              }`}
            >
              {i * 10}
            </span>
          ...
          <div
            className={`${
              orientation === "horizontal" ? "h-3 w-px" : "w-3 h-px"
            } bg-neutral-900`}
          />
        </div>
      ))}
...
const Hero = () => {
  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 min-h-screen flex flex-col justify-between bg-white overflow-hidden">
      ...
      <Container className="relative z-10 w-full flex-grow flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-8">
            ...
            >
              The Space <br />
              Defines the{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-neutral-400 to-neutral-200">
                Form.
              </span>
            </motion.h1>
            ...
            >
              <p className="text-lg md:text-xl text-neutral-500 font-light leading-relaxed max-w-md">
                An unopinionated UI primitive. Prioritizing negative space,
                typographic rhythm, and strict geometric precision over
                decoration.
              </p>
          ...
          >
            <div className="w-80 h-96 border border-neutral-200 relative p-8 flex flex-col justify-between group hover:border-neutral-900 transition-colors duration-700 bg-white">
              ...
              <div className="space-y-6 opacity-40 group-hover:opacity-100 transition-opacity duration-700">
                <div className="w-full h-32 bg-neutral-100 border border-neutral-200 relative overflow-hidden">
...
const PhilosophyItem = ({ number, title, desc }) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={`min-h-[60vh] flex flex-col justify-center transition-all duration-700 ${
        ...
        <div className="lg:w-5/12">
          <div className="sticky top-0 h-screen flex flex-col justify-center">
            <div className="mb-12 relative">
              ...
              <h2 className="text-5xl md:text-7xl font-bold tracking-tighter text-neutral-900 leading-[0.9]">
                Core <br />
                Principles
              </h2>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-l border-neutral-200 bg-white">
          ...
          <PreviewCard label="Interaction / Button">
            <div className="flex flex-col gap-3 w-full max-w-[200px]">
              <button className="h-11 px-6 bg-neutral-900 text-white text-sm font-medium hover:bg-neutral-800 transition-all active:scale-95 flex justify-between items-center group/btn">
                <span>Deploy</span>
                <ArrowUpRight
                  size={14}
              ...
              <button className="h-11 px-6 bg-white border border-neutral-200 text-neutral-900 text-sm font-medium hover:border-neutral-900 transition-colors active:scale-95 text-left">
                Documentation
              </button>
            </div>
          </PreviewCard>
    ...
    <Container>
      <div className="flex flex-col md:flex-row justify-between items-start mb-20 gap-12">
        <div className="max-w-md">
          <h2 className="text-8xl font-bold tracking-tighter text-neutral-900 mb-8">
            M.
          </h2>
      ...
      <div className="py-32 bg-white text-center border-t border-neutral-100">
        <Container>
          ...
          <p className="text-neutral-500 mb-8 font-light">
            Explore the component library and start building.
          </p>
          <a
            href="#"
