  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Positioner
        ...
        className={cn(
          "box-border h-[var(--positioner-height)] w-[var(--positioner-width)] max-w-[var(--available-width)] transition-[top,left,right,bottom] duration-[var(--duration)] ease-[var(--easing)] before:absolute before:content-[''] data-[instant]:transition-none",
...
function NavigationMenuPopup({
  ...
  return (
    <NavigationMenuPrimitive.Popup
      className={cn(
        "relative w-[var(--popup-width)] xs:w-[var(--popup-width)] h-[var(--popup-height)] origin-[var(--transform-origin)] rounded-lg bg-popover shadow-lg outline-1 outline-border dark:shadow-none dark:-outline-offset-1 transition-[opacity,transform,width,height,scale,translate] duration-[var(--duration)] ease-[var(--easing)] data-[ending-style]:easing-[ease]",
        "data-[ending-style]:opacity-0 data-[ending-style]:translate-y-2 data-[starting-style]:opacity-0 data-[starting-style]:translate-y-2",
        className
      )}
      {...props}
    >
