...
function DropdownMenuContent({
  ...
  return (
    <MenuPrimitive.Popup
      ...
      className={cn(
        "bg-popover text-popover-foreground max-h-(--available-height) min-w-[12rem] overflow-x-hidden overflow-y-auto rounded-lg py-1.5 shadow-xl border-none outline-1 outline-border/15",
...
function DropdownMenuItem({
  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        "data-highlighted:bg-accent/50 data-highlighted:text-accent-foreground [&_svg:not([class*='text-'])]:text-muted-foreground relative flex cursor-default items-center gap-2 rounded-none px-3.5 py-2 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
        variant === "destructive" &&
