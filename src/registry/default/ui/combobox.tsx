  ...
  return (
    <ComboboxPrimitive.Trigger
      ...
      render={
        <Button
          variant="outline"
          className="bg-background hover:bg-background border-input h-9 justify-between font-normal text-sm shadow-none aria-expanded:border-ring aria-expanded:ring-ring/30 aria-expanded:ring-[3px]"
        />
      }
      {...props}
    />
...
function ComboboxPopup({
  ...
  return (
    <ComboboxPrimitive.Popup
      ...
      className={cn(
        "relative overflow-hidden flex flex-col w-(--anchor-width) max-h-[min(24rem,var(--available-height))] max-w-(--available-width) origin-(--transform-origin) overflow-y-auto scroll-pt-2 scroll-pb-2 overscroll-contain rounded-lg bg-popover py-2 shadow-2xl outline-1 outline-border/20 transition-[transform,scale,opacity] data-[ending-style]:scale-95 data-[ending-style]:opacity-0 data-[side=none]:data-[ending-style]:transition-none data-[starting-style]:scale-95 data-[starting-style]:opacity-0 data-[side=none]:data-[starting-style]:scale-100 data-[side=none]:data-[starting-style]:opacity-100 data-[side=none]:data-[starting-style]:transition-none",
        className
      )}
      {...props}
    />
...
function ComboboxEmpty({
  ...
  return (
    <ComboboxPrimitive.Empty
      ...
      className={cn(
        "flex items-center justify-center text-muted-foreground text-sm not-empty:py-2 not-empty:px-4",
        className
      )}
      {...props}
    />
...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "grid cursor-default grid-cols-[0.95rem_1fr] items-center gap-2 py-2.5 pr-8 pl-4 text-sm leading-4 outline-none select-none data-[highlighted]:text-accent-foreground data-[highlighted]:bg-accent/50",
        className
      )}
      {...props}
    />
