  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration-350 ease-out",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-350 ease-out md:flex",
          side === "left"
...
function SidebarLeftIcon({ ...props }: React.ComponentProps<"svg">) {
  // prettier-ignore
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path d="M5 7H6M5 10H6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
    </svg>
  )
}
...
function SidebarMenuButton({
  ...
  return (
    <Tooltip>
      <TooltipTrigger render={button as React.ReactElement<any>} />
      <TooltipPositioner
        side="right"
        align="center"
