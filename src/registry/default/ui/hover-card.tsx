    ...
    <PreviewCardPrimitive.Portal>
      ...
      >
        <PreviewCardPrimitive.Popup
          ...
          className={cn(
            "relative flex w-64 origin-(--transform-origin) rounded-lg border border-transparent bg-popover/90 bg-clip-padding p-4 text-sm text-balance text-popover-foreground shadow-lg transition-[scale,opacity] before:pointer-events-none before:absolute before:inset-0 before:rounded-[calc(var(--radius-lg)-1px)] data-ending-style:scale-98 data-ending-style:opacity-0 data-starting-style:scale-98 data-starting-style:opacity-0",
