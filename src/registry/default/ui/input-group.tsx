...
function InputGroupInput({
  ...
  return (
    <Input
      className={cn(
        "bg-transparent border-0 shadow-none focus-visible:ring-0 dark:bg-transparent",
        className
      )}
      {...props}
    />
