...
export const styles: Registry["items"] = [
  {
    cssVars: {
      dark: {
        ...
        background:
          "color-mix(in srgb, var(--color-zinc-950) 98%, var(--color-white))",
        ...
        "muted-foreground":
          "color-mix(in srgb, var(--color-zinc-500) 90%, var(--color-white))",
        popover:
          "color-mix(in srgb, var(--background) 96%, var(--color-white))",
      ...
      light: {
        ...
        "muted-foreground":
          "color-mix(in srgb, var(--color-zinc-500) 90%, var(--color-black))",
